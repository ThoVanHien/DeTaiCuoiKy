	...
	<div class="page-content d-flex align-items-stretch">
			...
			<ul class="list-unstyled">
				...
				<li><a href="#exampledropdownDropdown" aria-expanded="false"
					...
					<ul id="exampledropdownDropdown" class="collapse list-unstyled show">
						...
						<li class="active"><a href="PHControl"> <i class="fa fa-comments"></i>Phản Hồi</a>
						</li>
					</ul>
				</a>
		...
		<div class="content-inner">
			<header class="page-header">
				<div class="container-fluid">
					<h2 class="no-margin-bottom">Danh Sách Phản Hồi</h2>
				</div>
			</header>
				...
				<div class="container-fluid">
					<div class="row bg-white has-shadow" style="float:none">
						...
						<div style="width:100%">
							<span>Lọc: </span> 
								<select class="tim">
									...
									<option >Phản hồi chưa đọc</option>
									<option >Phản hồi gần đây</option>
								</select> 						
						</div>
						...
						<table class="datahome">
							...
							<tr>
								<td>1</td>
								<td class="txt-jus">Góp ý về nhân viên</td>
								<td class="txt-jus">vananh@gmail.com</td>
								<td >19:00 10/12/2018</td>
								<td>Đã xem</td>
							...
							<tr>
								<td>2</td>
								<td class="txt-jus">Phản hồi về rạp phim</td>
								<td class="txt-jus">ngoclam@gmail.com</td>
								<td >20:29 14/12/2018</td>
								<td>Chưa xem</td>
