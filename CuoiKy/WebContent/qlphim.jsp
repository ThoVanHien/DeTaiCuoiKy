	...
	<div class="page-content d-flex align-items-stretch">
		<nav class="side-navbar">
			...
			<ul class="list-unstyled">
				...
				<li class="active"><a href="PhimControl"><i class="fa fa-film"></i>Phim</a></li>
		...
		<div class="content-inner">
			<header class="page-header">
				<div class="container-fluid">
					<h2 class="no-margin-bottom">Danh Sách Phim Chiếu</h2>
				</div>
			</header>
				...
				<div class="container-fluid">
					<div class="row bg-white has-shadow" style="float:none">
						...
						<div style="width:100%">
							<span>Tìm kiếm: </span> 
								<select class="tim">
									<option >Tìm theo mã phim</option>
						...
						<table class="datahome">
							<tr
								...
								<td >ID</td>
								<td style="width:250px;">Tên phim</td>
								<td style="width:160px">Đạo Diễn</td>
								<td >Quốc Gia</td>
								<td >Thể Loại</td>
								<td >Khởi Chiếu</td>
								<td >Trạng Thái</td>
							...
							<tr>
								...
								<td class="txt-jus">Kim Sung-hoon</td>
								<td>Hàn Quốc</td>
								<td>Tình Cảm</td>
								<td>02/01//2019</td>
								<td>Sắp Chiếu</td>
							...
							<tr>
								<td>2</td>
								<td class="txt-jus">Người Bất Tử</td>
								<td class="txt-jus">Victor Vũ</td>
								<td>Việt Nam</td>
								<td>Hành Động</td>
								<td>02/01//2019</td>
								<td>Sắp Chiếu</td>
							...
							<tr>
								<td>3</td>
								<td class="txt-jus">The Nutcracker and the Four Realms</td>
								<td class="txt-jus">Lasse Hallström, Joe Johnston</td>
								<td>Mỹ</td>
								<td>Phiêu Lưu</td>
								<td>02/01//2019</td>
								<td>Sắp Chiếu</td>
