	...
	<div class="page-content d-flex align-items-stretch">
		<nav class="side-navbar">
			...
			<ul class="list-unstyled">
				...
				<li  class="active"><a href="PCControl"><i class="fa fa-windows"></i>Phòng Chiếu</a></li>
		...
		<div class="content-inner">
			<header class="page-header">
				<div class="container-fluid">
					<h2 class="no-margin-bottom">Danh Sách Phòng Chiếu</h2>
				</div>
			</header>
				...
				<div class="container-fluid">
					<div class="row bg-white has-shadow" style="float:none">
						...
						<div style="width:100%">
							<span>Tìm kiếm: </span> 
								<select class="tim">
									<option >Tìm theo tên phòng</option>
						...
						<table class="datahome">
							...
							<tr>
								<td class="txt-jus">LHD Star Q1</td>
								<td>4</td>
								<td>P1</td>
								<td>140</td>
