			...
			<ul class="list-unstyled">
				...
				<li><a href="#exampledropdownDropdown" aria-expanded="false"
					...
					<ul id="exampledropdownDropdown" class="collapse list-unstyled show">
						...
						<li class="active"><a href="SKControl"> <i class="fa fa-gift"></i>Sự Kiện
						</a></li>
					...
					<div class="row bg-white has-shadow" style="float:none">
						...
						<div style="width:100%">
							<span>Tìm kiếm: </span> 
								...
								<button class="bn btn-primary" style="float:right"><a href="new" class="new">Thêm mới</a></button>
						...
						<table class="datahome">
							<tr
								...
								<td style="width:130px">Ngày Bắt Đầu</td>
								<td style="width:136px">Ngày Kết Thúc</td>
								<td style="width:110px"></td>
							</tr>
							
							<%-- <c:forEach var="sk" items="${listsk}">
							<tr>
								<td>${sk.masukien}</td>
								<td class="txt-jus">${sk.tensk}</td>
								<td class="txt-jus">
								...
								<td>
								<a href="edit?mask=<c:out value='${sk.mask}' />" title="Sửa"><i class="fa fa-edit"></i></a>&nbsp
									<a href="delete?mask=<c:out value='${sk.mask}' />" title="Xoá"><i class="fa fa-times"></i></a>&nbsp <input
							...
							<c:forEach var="sk" items="${listsk}">
								<tr>
									<td>${sk.mask}</td>
									<td class="txt-jus">${sk.tensk}</td>
									<td class="txt-jus"><div style="width:100%; height:100px; overflow-y:scroll">
									${sk.noidung}
									</div></td>
									<td>${sk.tgbatdau}</td>
									<td>${sk.tgketthuc}</td>
									<td><a href="edit?mask=<c:out value='${sk.mask}' />" title="Sửa"><i class="fa fa-edit"></i></a>&nbsp
									<a href="delete?mask=<c:out value='${sk.mask}' />" title="Xoá"><i class="fa fa-times"></i></a>&nbsp <input
									type="checkbox" name=""></td>
								</tr>
							</c:forEach>
