	...
	<div class="page-content d-flex align-items-stretch">
		<nav class="side-navbar">
			...
			<ul class="list-unstyled">
				...
				<li><a href="TVControl"> <i class="fa fa-users"></i>Thành Viên
					...
					<li class="active"><a href="TKControl"> <i class="fa fa-address-book"></i>Tài Khoản
					</a></li>
			</ul>
		</nav>
		<div class="content-inner">
			<header class="page-header">
				<div class="container-fluid">
					<h2 class="no-margin-bottom">Danh Sách Tài Khoản</h2>
				</div>
			</header>
				...
				<div class="container-fluid">
					<div class="row bg-white has-shadow" style="float:none">
						...
						<table class="datahome">
							...
							<tr>
								<td>1</td>
								<td class="txt-jus">0964738434</td>
								<td class="txt-jus">Lê Phúc</td>
								<td >0964738434</td>
								<td class="txt-jus">Quản Trị Viên</td>
							...
							<tr>
								...
								<td class="txt-jus">Nguyễn Ngọc Linh</td>
								<td >0965234176</td>
								<td class="txt-jus">Thành Viên</td>
