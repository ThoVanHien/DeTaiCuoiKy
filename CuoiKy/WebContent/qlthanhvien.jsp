	...
	<div class="page-content d-flex align-items-stretch">
		<nav class="side-navbar">
			...
			<ul class="list-unstyled">
				...
				<li class="active"><a href="TVControl"> <i class="fa fa-users"></i>Thành Viên
					</a></li>
		...
		<div class="content-inner">
			<header class="page-header">
				<div class="container-fluid">
					<h2 class="no-margin-bottom">Danh Sách Thành Viên</h2>
				</div>
			</header>
				...
				<div class="container-fluid">
					<div class="row bg-white has-shadow" style="float:none">
						...
						<table class="datahome">
							...
							<tr>
								<td>1</td>
								<td style="text-align: left">Nguyễn Ngọc Linh</td>
								<td class="txt-jus">ngoclinh@gmail.com</td>
								<td>0947364834</td>
								<td>02/09/1998</td>
								<td class="txt-jus">03 đường số 8, Linh Trung, Thủ Đức, TPHCM</td>
							...
							<tr>
								<td>2</td>
								<td class="txt-jus">Lê Thị Minh Anh</td>
								<td class="txt-jus">minhanhh@gmail.com</td>
								<td>0936427352</td>
								<td>16/03/1997</td>
								<td class="txt-jus">18 Lê Văn Việt, Tăng Nhơn Phú B, Quận 9, TPHCM</td>
								
								<td>
								<a href="edit_rap.html"><i class="fa fa-edit"></i></a>&nbsp
									<a href="#"><i class="fa fa-times"></i></a>&nbsp <input
									type="checkbox" name=""></td>
							</tr>
						</table>
