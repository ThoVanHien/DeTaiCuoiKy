	...
	<div class="page-content d-flex align-items-stretch">
			...
			<ul class="list-unstyled">
				...
				<li><a href="#exampledropdownDropdown" aria-expanded="false"
					...
					<ul id="exampledropdownDropdown" class="collapse list-unstyled show">
						<li class="active"><a href="TAControl"> <i class="fa fa-glass"></i>Thức Ăn Nhanh
						</a></li>
		...
		<div class="content-inner">
			<header class="page-header">
				<div class="container-fluid">
					<h2 class="no-margin-bottom">Danh Sách Thức Ăn Nhanh</h2>
				</div>
			</header>
				...
				<div class="container-fluid">
					<div class="row bg-white has-shadow" style="float:none">
						...
						<div style="width:100%">
							<span>Tìm kiếm: </span> 
								<select class="tim">
									<option >Tìm theo mã thức ăn</option>
									<option >Tìm theo tên thức ăn</option>
								</select> 
						...
						<table class="datahome">
							...
							<tr>
								<td>1</td>
								<td class="txt-jus">Christmas 1</td>
								<td class="txt-jus">1 bắp (ngọt/mặn) + 1 bánh: TWISTER, KITKAT, COSY, POCKY, ĐẬU WASABI</td>
								<td>90000</td>
							...
							<tr>
								<td>2</td>
								<td class="txt-jus">Christmas 2</td>
								<td class="txt-jus">1 bắp (ngọt/mặn) + 2 nước (PEPSI/7UP/MIRINDA CAM/MIRINDA SARSI)</td>
								<td>130000</td>
							...
							<tr>
								<td>3</td>
								<td class="txt-jus">Combo 1</td>
								<td class="txt-jus">1 bắp (ngọt/mặn) + 1 nước (PEPSI/7UP/MIRINDA CAM/MIRINDA SARSI)</td>
								<td>70000</td>
							...
							<tr>
								<td>4</td>
								<td class="txt-jus">Combo 2</td>
								<td class="txt-jus">1 bắp (ngọt/mặn) + 2 chai nước tinh khiết</td>
								<td>60000</td>
